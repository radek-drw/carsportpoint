    ...
    <article>
      <div className="flex w-full flex-col md:flex-row">
        ...
        <div className="px-mobile-padding w-full pt-[70px] md:basis-1/2 md:px-[4vw]">
          ...
          <h2 className="text-articleHead mb-20 text-4xl font-black tracking-wide sm:text-5xl lg:text-6xl">
            We are CarSportPoint <br />
            We provide
            <span className="text-customRed"> engine tuning & remaps</span>
          </h2>
          <Divider size="194px" orientation="horizontal" />
          <h3 className="text-articleHead mt-14 text-sm font-medium sm:text-base md:pr-[39%] md:text-lg lg:text-xl">
            Vivamus nec leo enim. Aliquam erat volutpat. Sed et auctor felis, quis consectetur
            justo. Sed et interdum turpis? Ut gravida ut purus vel luctus? Duis volutpat.
          </h3>
        </div>
      </div>
      ...
      <div className="relative mt-14 flex flex-col md:mt-20 md:flex-row">
        ...
        <div className="px-mobile-padding flex flex-1 flex-col md:flex-row md:px-[2vw]">
          <div className="md:basis-1/2 md:px-[2vw]">
            <h3 className="text-articleHead pb-4 text-sm font-medium sm:text-base md:text-lg lg:text-xl">
              Aenean aliquet facilisis arcu, at tristique arcu vestibulum nec. Fusce tincidunt ante
              et nunc posuere posuere. Donec venenatis mi eleifend, laoreet nulla metus.
            </h3>
            <p className="text-customGrey text-sm lg:text-lg">
          ...
          <div className="pt-10 md:basis-1/2 md:px-[2vw] md:pt-36">
            <p className="text-customGrey pb-4 text-sm lg:text-lg">
              ...
              laudantium, totam rem ape.
            </p>
            <p className="text-customGrey text-sm lg:text-lg">
              Riam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae
              ...
              nesciunt. Neque empora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.
            </p>
          </div>
        </div>
