...
const PerformanceArticle = () => {
  return (
    <article className="mt-28 flex flex-col md:flex-row md:px-[2vw]">
      ...
      <div className="px-mobile-padding mb-14 basis-[1/4] md:mb-0 md:px-[2vw]">
        <h3 className="text-articleHead pb-4 text-sm font-medium sm:text-base md:text-lg lg:text-xl">
          Curabitur ullamcorper vehicula metus quis laoreet! Maecenas non metus enim. Aliquam eu
          hendrerit ligula, sed malesuada nisl! Nam sed lacus auctor viverra fusce.
        </h3>
