...
const API_URL = 'https://vkaymzas8j.execute-api.eu-west-1.amazonaws.com/saveCompanyDetails';
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      {inputsConfig.map(({ name, type, placeholder }) => (
        <input
          ...
          className="hover:border-inputBorder focus:border-inputBorder focus:shadow-inputShadow w-full rounded-md border p-2"
          required
        />
      ))}
      <ImageUpload />
