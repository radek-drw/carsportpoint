      ...
      <article>
        ...
        <div className="flex flex-col md:flex-row md:pl-[4vw]">
          <div className="px-mobile-padding basis-1/2 pt-32 md:pl-0 md:pr-[3vw] md:pt-36">
            <h1 className="text-customRed mb-9 text-2xl font-bold uppercase sm:text-3xl md:text-4xl">
              our partners
            </h1>
            ...
            <h3 className="text-articleHead mb-4 mt-14 text-sm font-medium sm:text-base md:pr-[46%] md:text-lg lg:text-xl">
              Mauris vel tellus in urna volutpat tempus? Proin viverra varius massa nec commodo.
              Cras aliquet leo ut tellus.
            </h3>
            <p className="text-customGrey text-sm md:pr-[46%]">
              Proin ac leo eu nisi congue ornare eget lobortis ante. Nunc fermentum elementum felis
              quis dignissim. Aliquam vitae elit tellus. Nunc ac est ut lorem cras amet.
            </p>
          </div>
        ...
        <div className="mx-auto grid grid-cols-1 gap-4 pb-10 pt-5 md:max-w-[748px] md:grid-cols-5 md:px-6 lg:max-w-[1004px] xl:max-w-[1260px]">
          {partners.map((partner, index) => (
            <div key={index} className="mx-auto flex w-[90%] items-center justify-center md:w-auto">
              <ResponsiveImage
                sources={[
